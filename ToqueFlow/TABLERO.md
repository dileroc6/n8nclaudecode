...
| 62 | 🟢 **Encender WhatsApp en Bejauha — ya no falta nada antes** | **Es el último paso del go-live y ya está todo lo demás:** corre solo sobre el estándar (fila 25), su conocimiento está cargado y **confirmado como vigente** (fila 147), y Toque Recargas existe para lo que el sistema viejo hacía. **Hoy no tiene ninguna instancia en Evolution** — se crea desde la consola, que muestra el QR y se entera sola cuando conecta (fila 40). **Y el ensayo ya se hizo:** el agente contesta con los precios reales por `dev-router`. Lo que queda es escanear el QR con el celular del negocio | Diego |
