...
| 9 | **Arrancar el cargador de conocimiento** — el 40% del costo de implementar está ahí | La herramienta está lista y probada (fila 27). Falta apuntarla a un cliente y ver qué saca. **El candidato obvio es Bejauha**, que es el caso de referencia y hoy tiene el conocimiento **vacío** — sirve doble: deja el caso bien armado y cronometra cuánto cuesta de verdad implementar | Diego |
