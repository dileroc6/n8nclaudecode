...
| # | Tarea | Nota |
|---|---|---|
| 39 | **Que el CLIENTE pueda configurar su propio agente** | Hoy el tono, los campos a capturar y las opciones solo se tocan desde la consola de ToqueFlow. El cliente ya edita su base de contactos y su conocimiento; **lo que no puede es cambiar cómo habla su agente ni qué datos pide** — y eso es justo lo que va a querer ajustar cada semana. Mientras siga en la consola, cada ajuste menor pasa por Diego | Diego |
...
| 42 | **Decidir el nombre del producto estándar** | Propuesta: **«Toque Atiende»** — verbo, dice lo que hace, y abre familia (Toque Agenda, Toque Factura). Hoy se llama «Agente de Atención», que es descriptivo pero no es una marca. Es tu decisión; si te gusta, se cambia en el catálogo y en el sitio | Diego |
...
| 96 | Limpiar el historial de git | Opcional. Exige `push --force` | Diego |
