...
| 120 | ⭐ **Toque Tienda — 0 de 4, y antes creíamos que eran 2** | Al ir a migrar a Savia y FerreteríaYa (fila 26) apareció que el paquete **no cubre lo que hacen sus agentes**. Llevaba `estado-pedido` y `confirmar-pago`; les falta lo que hacen todo el día: **buscar en el catálogo** —precio y existencias de verdad, no de memoria— y **crear el pedido**. Las dos se agregaron al catálogo el 10-sep. **Como matricular y recargar, crear un pedido COMPROMETE al negocio**, así que la confirmación final la da una persona. **Y es el paquete que desbloquea la migración de los dos clientes que más horas consumen.** Falta decidir contra qué plataforma va primero: el WooCommerce de Savia o el Siigo de FerreteríaYa | Diego |
